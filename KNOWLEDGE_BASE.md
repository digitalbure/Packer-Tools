...
## 📷 0.000000. Real-Time Camera Barcode & QR Scanner Integration (v6.22.0)
...
## 🤖 0.00. Model Context Protocol (MCP) Server & Claude Marketing Agent Connector (v6.22.0)
...
- `get_release_notes`: Fetches current version notes (`v6.22.0`) and full changelog history directly from `RELEASE.md`.
