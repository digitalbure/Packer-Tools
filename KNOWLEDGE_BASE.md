...
## 📷 0.000000. Real-Time Camera Barcode & QR Scanner Integration (v6.21.1)
...
## 🤖 0.00. Model Context Protocol (MCP) Server & Claude Marketing Agent Connector (v6.21.1)
...
- `get_release_notes`: Fetches current version notes (`v6.21.1`) and full changelog history directly from `RELEASE.md`.
