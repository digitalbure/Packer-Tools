...
## 📷 0.000000. Real-Time Camera Barcode & QR Scanner Integration (v6.1.3)
...
## 🤖 0.00. Model Context Protocol (MCP) Server & Claude Marketing Agent Connector (v6.1.3)
...
- `get_release_notes`: Fetches current version notes (`v6.1.3`) and full changelog history directly from `RELEASE.md`.
