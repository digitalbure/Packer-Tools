...
## 🤖 0.00. Model Context Protocol (MCP) Server & Claude Marketing Agent Connector (v5.18.1)
...
- `get_release_notes`: Fetches current version notes (`v5.18.1`) and full changelog history directly from `RELEASE.md`.
