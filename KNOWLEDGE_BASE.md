...
## 🤖 0.00. Model Context Protocol (MCP) Server & Claude Marketing Agent Connector (v6.0.3)
...
- `get_release_notes`: Fetches current version notes (`v6.0.3`) and full changelog history directly from `RELEASE.md`.
