...
import LeftPanelOrganizer from '../components/LeftPanelOrganizer';
          ...
          <section className="bg-white p-5 sm:p-10 rounded-2xl sm:rounded-[3rem] border border-primary/5 shadow-sm space-y-6 sm:space-y-8 animate-fade-in animate-duration-300">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                ]).filter(c => c.isActive).map((c, cIdx) => {
              ...
              <div className="pt-8 border-t border-neutral-100 space-y-6">
                ...
                {/* Left Panel & Quick Access Customizer */}
                <div className="pt-6">
                  <LeftPanelOrganizer user={user} onUpdate={onUpdate} />
                </div>
              </div>
        ...
        {activeTab === 'notifications' && (
          <div className="space-y-8 sm:space-y-12 animate-fade-in">
            ...
            <header className="space-y-1">
              <span className="micro-label bg-green-50 text-green-600 border border-green-200 px-2 py-0.5 rounded-full inline-block font-black">Release Build v{APP_VERSION}</span>
              <h3 className="text-xl font-black uppercase tracking-tighter flex items-center gap-3">
