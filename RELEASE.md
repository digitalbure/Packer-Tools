...
### 🔌 Feature Release: v6.4.0 (Kiosk Phase 2a: Kiosk UI on the Server API, Server-verified Pairing)
...
- New client module `src/lib/kioskApi.ts`; `tests/kiosk-client-e2e.mts` (17 checks) runs it against the real server. `npm test` now runs 151 checks.
